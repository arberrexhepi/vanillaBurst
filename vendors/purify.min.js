...
!(function (e, t) {
  ...
  return (function e() {
    ...
    var oe = V(Z, r),
      ...
      fe = {};
    try {
      fe = x(o).documentMode ? o.documentMode : {};
    } catch (e) {}
    var de = {};
    n.isSupported =
      "function" == typeof ne &&
    ...
    var pe = H,
      ...
      Te = P,
      Ne = null,
      Ae = E({}, [].concat(Y(k), Y(S), Y(_), Y(O), Y(M))),
      Ee = null,
      xe = E({}, [].concat(Y(L), Y(R), Y(I), Y(F))),
      we = Object.seal(
        Object.create(null, {
          tagNameCheck: {
            writable: !0,
      ...
      We = null,
      qe = E({}, ["audio", "video", "img", "source", "image", "track"]),
      Ye = null,
      Ke = E({}, [
        "alt",
        "class",
      ...
      at = function (e) {
        (rt && rt === e) ||
          ((e && "object" === (void 0 === e ? "undefined" : q(e))) || (e = {}),
          (e = x(e)),
          (Ne = "ALLOWED_TAGS" in e ? E({}, e.ALLOWED_TAGS) : Ae),
          (Ee = "ALLOWED_ATTR" in e ? E({}, e.ALLOWED_ATTR) : xe),
          (Ye = "ADD_URI_SAFE_ATTR" in e ? E(x(Ke), e.ADD_URI_SAFE_ATTR) : Ke),
          (We = "ADD_DATA_URI_TAGS" in e ? E(x(qe), e.ADD_DATA_URI_TAGS) : qe),
          (je = "FORBID_CONTENTS" in e ? E({}, e.FORBID_CONTENTS) : Ge),
          ...
          (Qe = Qe =
            -1 === et.indexOf(e.PARSER_MEDIA_TYPE) ? tt : e.PARSER_MEDIA_TYPE),
          (nt =
          ...
          Pe &&
            ((Ne = E({}, [].concat(Y(M)))),
            (Ee = []),
            !0 === Pe.html && (E(Ne, k), E(Ee, L)),
            !0 === Pe.svg && (E(Ne, S), E(Ee, R), E(Ee, F)),
            !0 === Pe.svgFilters && (E(Ne, _), E(Ee, R), E(Ee, F)),
            !0 === Pe.mathMl && (E(Ne, O), E(Ee, I), E(Ee, F))),
          e.ADD_TAGS && (Ne === Ae && (Ne = x(Ne)), E(Ne, e.ADD_TAGS)),
          e.ADD_ATTR && (Ee === xe && (Ee = x(Ee)), E(Ee, e.ADD_ATTR)),
          e.ADD_URI_SAFE_ATTR && E(Ye, e.ADD_URI_SAFE_ATTR),
          e.FORBID_CONTENTS &&
            (je === Ge && (je = x(je)), E(je, e.FORBID_CONTENTS)),
          ze && (Ne["#text"] = !0),
          Me && E(Ne, ["html", "head", "body"]),
          Ne.table && (E(Ne, ["tbody"]), delete ke.tbody),
          i && i(e),
          (rt = e));
      },
      lt = E({}, ["mi", "mo", "mn", "ms", "mtext"]),
      ct = E({}, ["foreignobject", "desc", "title", "annotation-xml"]),
      st = E({}, S);
    E(st, _), E(st, D);
    var ut = E({}, O);
    E(ut, C);
    var mt = function (e) {
      ...
      pt = function (e) {
        ...
        if (Ze === Xe)
          try {
            t = new X().parseFromString(i, Qe);
          } catch (e) {}
        if (!t || !t.documentElement) {
          t = le.createDocument(Ze, "template", null);
          try {
            t.documentElement.innerHTML = Je ? "" : i;
          } catch (e) {}
        }
      ...
      bt = function (e) {
        ...
        if (g(e.nodeName, /[\u0080-\uFFFF]/)) return ft(e), !0;
        var r = nt(e.nodeName);
        if (
          (vt("uponSanitizeElement", e, { tagName: r, allowedTags: Ne }),
          ...
          return ft(e), !0;
        if ("select" === r && T(/<template/i, e.innerHTML)) return ft(e), !0;
        if (!Ne[r] || ke[r]) {
          if (!ke[r] && Nt(r)) {
            if (we.tagNameCheck instanceof RegExp && T(we.tagNameCheck, r))
              return !1;
            if (we.tagNameCheck instanceof Function && we.tagNameCheck(r))
              return !1;
          }
          if (ze && !je[r]) {
      ...
      Tt = function (e, t, n) {
        if (Ue && ("id" === t || "name" === t) && (n in o || n in ot))
          return !1;
        if (De && !Se[t] && T(ge, t));
        else if (_e && T(ye, t));
        else if (!Ee[t] || Se[t]) {
        ...
        if (a) {
          ...
          for (i = a.length; i--; ) {
            ...
            if (
              ...
              (r = l.attrValue),
              !l.forceKeepAttr && (dt(s, e), l.keepAttr))
            )
              if (T(/\/>/i, r)) dt(s, e);
              else {
                Ce && ((r = y(r, pe, " ")), (r = y(r, he, " ")));
                var m = nt(e.nodeName);
                if (Tt(m, o, r))
                  try {
      ...
      Et = function e(t) {
        ...
        for (vt("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
          vt("uponSanitizeShadowNode", n, null),
            bt(n) || (n.content instanceof a && e(n.content), At(n));
    ...
    return (
      (n.sanitize = function (e, o) {
        var i = void 0,
          ...
          m = void 0;
        if (
          ((Je = !e) && (e = "\x3c!--\x3e"), "string" != typeof e && !yt(e))
        ) {
        ...
        if (
          (Le || at(o), (n.removed = []), "string" == typeof e && (Be = !1), Be)
        ) {
          if (e.nodeName) {
            var f = nt(e.nodeName);
            if (!Ne[f] || ke[f])
          ...
          (1 ===
            (l = (i = pt("\x3c!----\x3e")).ownerDocument.importNode(e, !0))
              .nodeType &&
            "BODY" === l.nodeName) ||
          "HTML" === l.nodeName
            ? (i = l)
          ...
          if (!Ie && !Ce && !Me && -1 === e.indexOf("<"))
            return oe && He ? oe.createHTML(e) : e;
          if (!(i = pt(e))) return Ie ? null : He ? ie : "";
        }
        i && Re && ft(i.firstChild);
        for (var d = ht(Be ? e : i); (s = d.nextNode()); )
          (3 === s.nodeType && s === u) ||
            bt(s) ||
            (s.content instanceof a && Et(s.content), At(s), (u = s));
        if (((u = null), Be)) return e;
        if (Ie) {
          if (Fe)
            for (m = se.call(i.ownerDocument); i.firstChild; )
              m.appendChild(i.firstChild);
          else m = i;
          return Ee.shadowroot && (m = me.call(r, m, !0)), m;
        }
        ...
        return (
          Me &&
            ...
            T(W, i.ownerDocument.doctype.name) &&
            (p = "<!DOCTYPE " + i.ownerDocument.doctype.name + ">\n" + p),
          Ce && ((p = y(p, pe, " ")), (p = y(p, he, " "))),
          oe && He ? oe.createHTML(p) : p
        );
      }),
